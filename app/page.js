    ...
    return (
        <div className="flex flex-col min-h-screen dark:bg-gray-900">
                ...
                <section className="relative py-20 px-4 bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white">
                    <div className="max-w-6xl mx-auto text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight animate-[fadeIn_1s_ease-in]">
                            Your Personal AI Voice Coach
                        </h1>
                        <p className="text-lg md:text-xl mb-8 text-gray-300/90 max-w-3xl mx-auto">
                            Master your speaking skills with real-time AI feedback. 
                            Perfect for interviews, presentations, language learning, and more.
                        </p>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">Real-time Analysis</h3>
                                <p className="text-gray-600 dark:text-gray-300">
                                    Get instant feedback on your speech patterns, tone, 
                                    and delivery with advanced AI processing.
                                </p>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">Guided Practice</h3>
                                <p className="text-gray-600 dark:text-gray-300">
                                    Choose from various coaching scenarios including 
                                    interview prep, presentations, and language practice.
                                </p>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                                ...
                                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">Smart Insights</h3>
                                <p className="text-gray-600 dark:text-gray-300">
                                    Receive personalized improvement suggestions and 
            ...
            <footer className="text-center py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 text-sm text-gray-500 dark:text-gray-400">
                © {new Date().getFullYear()} AI Voice Coach. All rights reserved.
            </footer>
        </div>
    );
}
